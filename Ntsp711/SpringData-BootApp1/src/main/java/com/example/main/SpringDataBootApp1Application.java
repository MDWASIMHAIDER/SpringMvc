...
public class SpringDataBootApp1Application {
	...
	//	System.out.println("Student Registered successfully with id  "+service.registerEmp(dto));
		...
		System.out.println("Student detail  between numbers"+service.findEmpBetweenNumbers(43, 48));
	//	System.out.println("employee salary update "+service.addBonus(45, 1300));
	//	System.out.println("employee delete "+service.deleteEmp(47));
		System.out.println("find all record "+service.fetchAllEmps());
	}
