...
public class ScientistDAIOImpl implements ScientistDAO {
	...
	private static final String SCIENTIST_BY_ID="SELECT *FROM SCIENTIST_DETAIL WHERE SNO=?";
	...
	public int addScientist(ScientistBO bo) {
		...
		res=jt.update(ADD_SCIENTIST, bo.getSno(),bo.getSname(),bo.getDomain(),bo.getExperiance(),bo.getPatantCounts());
		return res;
	}
